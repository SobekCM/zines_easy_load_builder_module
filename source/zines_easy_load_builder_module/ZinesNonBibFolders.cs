...
namespace zines_easy_load_builder_module
{
    public class ZinesNonBibFolders : abstractFolderModule
    {
        ...
        public override void DoWork(Actionable_Builder_Source_Folder BuilderFolder, List<Incoming_Digital_Resource> IncomingPackages, List<Incoming_Digital_Resource> Deletes)
        {
            ...
            foreach (string thisSubDir in subdirs)
            {
                try
                {
                    ...
                    newItem.Bib_Info.SobekCM_Type = TypeOfResource_SobekCM_Enum.Mixed_Material;
                    ...
                    newItem.Bib_Info.Location.Holding_Name = "The Wolfsonian-Florida International University";
                    newItem.Bib_Info.Add_Genre("periodical");
                    newItem.BibID = "AA";
                    newItem.VID = "00001";
                    newItem.Behaviors.Add_Aggregation("ZINES");
